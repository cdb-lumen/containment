...
> Historical FAIL for the rejected initial package. The original review and all
> original evidence are byte-preserved in `rejected-initial/`. The repaired
> candidate has not received independent re-review. The report below is not
> a verdict on the repaired files.
