...
it('production InputController supplies visible body colliders and uses corrected aim',()=>{
 ...
 const input=Object.assign(Object.create(InputController.prototype),{game,view:{pointer},keys:new Set(),movement:{x:0,y:0},aim:null,mouse:{x:300,y:250,active:true},touchFire:false,shooting:true}) as InputController;
