...
export class DepthRenderer {
 ...
 dispose(){disposeModel(this.world);this.temporaryMaterials.forEach(m=>m.dispose());this.actorPool.dispose();this.healthBars.dispose();this.effects.dispose();this.renderer.dispose();this.composer.dispose();this.surfaces.dispose();}
}
